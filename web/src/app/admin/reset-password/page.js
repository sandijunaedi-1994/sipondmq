...
function ResetPasswordForm() {
  ...
  if (!token || !id) {
    return (
      <div className="bg-red-50 text-red-600 p-6 rounded-2xl max-w-md text-center border border-red-200 w-full z-10">
...
export default function ResetPasswordPage() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50 dark:bg-slate-950 transition-colors relative overflow-hidden">
      <Suspense fallback={<div className="text-emerald-600 text-lg font-bold animate-pulse z-10">Memuat...</div>}>
        <ResetPasswordForm />
      </Suspense>
    </div>
  );
