  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-800 dark:text-slate-100">Data Pegawai SDM</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Kelola data seluruh pegawai, staf, dan pengajar MQBS.</p>
        </div>
        <button 
