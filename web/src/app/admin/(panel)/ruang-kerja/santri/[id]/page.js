...
export default function WaliKelasSantriDetailPage() {
  const { id } = useParams();
  ...
  useEffect(() => {
    const fetchDetail = async () => {
      try {
        ...
        // We reuse the same API endpoint to get the Santri data
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-slate-500 font-medium animate-pulse">Memuat profil santri perwalian...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4 w-full pb-8">
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">Profil santri perwalian Anda.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden relative">
        <div className="h-20 bg-gradient-to-r from-teal-500 to-emerald-600"></div>
          ...
          <div className="flex flex-col sm:flex-row gap-5 items-start sm:items-end -mt-10 mb-4">
            ...
            <div className="flex-1 pb-1">
              <div className="flex flex-wrap items-center gap-2 mb-1">
                ...
                <span className="px-2 py-0.5 bg-teal-100 dark:bg-teal-500/10 text-teal-700 dark:text-teal-400 font-bold text-[10px] rounded border border-teal-200 dark:border-teal-500/20 uppercase tracking-wider">
                  {santri.status}
                </span>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="md:col-span-1 space-y-4">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-5">
            <h3 className="text-xs font-black text-slate-800 dark:text-white uppercase tracking-wider border-b border-slate-100 dark:border-slate-800 pb-2 mb-3">Kontak Wali Santri</h3>
        ...
        <div className="md:col-span-3 space-y-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 text-center min-h-[200px] flex flex-col items-center justify-center">
            ...
            <h3 className="text-lg font-bold text-slate-800 dark:text-white mb-1.5">Fitur Perwalian Segera Hadir</h3>
            <p className="text-slate-500 dark:text-slate-400 max-w-sm mx-auto text-xs">
              Modul untuk memantau capaian tahfidz, kehadiran, poin pelanggaran, serta input catatan pembinaan oleh Wali Kelas akan segera tersedia di sini.
            </p>
          </div>
        </div>
